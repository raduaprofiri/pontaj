...
(() => {
/*!******************************************!*\
  !*** ./resources/js/admin/dashboarde.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
...
new vue__WEBPACK_IMPORTED_MODULE_1__.default({
  ...
  methods: {},
  mounted: function mounted() {
    var chart = new (apexcharts__WEBPACK_IMPORTED_MODULE_0___default())(document.querySelector('#chart'), this.options);
    chart.render();
    var chart = new (apexcharts__WEBPACK_IMPORTED_MODULE_0___default())(document.querySelector('#chart2'), this.options2);
    chart.render();
  }
});
})();
