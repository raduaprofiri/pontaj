...
class FillPermissionsForTimekeeping extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTimekeeping constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.timekeeping.create',
            'admin.timekeeping.show',
            'admin.timekeeping.edit',
            'admin.timekeeping.delete',
            'admin.timekeeping.bulk-delete',
        ]);
