<div
	...
	:class="{'has-danger': errors.has('leader_id'), 'has-success': this.fields.leader_id && this.fields.leader_id.valid }"
>
	<label
		for="leader_id"
...
>
	<label
		...
		:class="isFormLocalized ? 'col-md-4' : 'col-md-2'"
	>
		{{ trans('admin.project.columns.name') }}
	</label>
...
>
	<label
		...
		:class="isFormLocalized ? 'col-md-4' : 'col-md-2'"
	>
		{{ trans('admin.project.columns.description') }}
	</label>
	<div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
		<div>
			<wysiwyg
